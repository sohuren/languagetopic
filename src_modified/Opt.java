...
public class Opt {
    ...
    static void calculateProbsSoft(Paragraph paragraph) {
        ...
        for (Question Q : paragraph.questions) {
            ...
            if(mctestmain.MIXED_SINGLE_MULTI && Q.type!=1) continue;
    ...
    static void MStep() throws LBFGSBException {
        ...
        System.out.println("Optimize the objective function ");

        Minimizer alg = new Minimizer();
        alg.getStopConditions().setMaxIterations(20); // 200 set the maximum minimizer
...
//        alg.setBounds(bounds); //IMP: use this to force positive weights
        ...
        System.out.println("Final Objective Value: " + Double.toString(finalValue));
        System.out.println("Final Gradient Sum: " + Double.toString(Tools.squareSum(finalGradient)));
        ...
        // System.out.println("The weight dimension: " + Double.toString(SentRel.feature2Weight.size()));
